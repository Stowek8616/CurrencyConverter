...
/**
 * JordiCurrencyConverter - A currency conversion application that allows users
 * to convert between USD and various foreign currencies with customizable fees.
 */
public class JordiCurrencyConverter extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            JordiCurrencyConverter app = new JordiCurrencyConverter();
            app.setVisible(true);
        });
    }
     ...
     */
    public JordiCurrencyConverter() {
        super(APP_NAME);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        // Initialize user preferences and currency data model
        prefs = Preferences.userNodeForPackage(JordiCurrencyConverter.class);
    ...
    private void setupSearchableComboBox() {
        ...
        editor.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                for (String currency : JordiCurrencyConverter.this.model.getCurrencies()) {
